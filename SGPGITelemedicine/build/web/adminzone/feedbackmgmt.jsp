    ...
    <body>
        <form>
            <div id="a_outer">
                ...
                <div id="a_container">
                    <h1 style="text-align:center;font-size:39.5px;color:grey;"><u><i>Feedback Management</i></u></h1>
                    <br/><br/><br/>
                    <table border="0" style="text-align:center;width:100%;font-size:20px;font-family:calibri;border:1px solid darkgrey;color:grey;border-radius:15px;">
                        ...
                        <tr>
                            ...
                            <td><a href="admincode/deletefeedback.jsp?id=<%=rs.getString(1)%>" style="text-decoration:none;color:lightcoral;">Delete</a></td>
                        </tr>
                        <% n++; } %>
                    </table>
                </div>
